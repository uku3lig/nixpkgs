    ...
    systemd.services.reposilite = {
      ...
      script =
        ...
        + ''
          ...
          ${lib.getExe cfg.package} --local-configuration ${configFile} --local-configuration-mode none --working-directory ${cfg.workingDirectory} ${lib.strings.concatStringsSep " " cfg.extraArgs}
        '';
